...
const UPDATE_PRODUCTIVITY = gql`
  mutation UpdateSoftSkill($input: UpdateSoftSkillInput!, $id: String!) {
...
export default function UpdateSoftSkill({
  show,
  handleClose,
  setShow,
  softSkill,
        ...
        <div className=" w-97 bg-white rounded-lg shadow ">
          <div className="p-8">
            <div className="flex flex-row justify-between">
              <h1 className="text-3xl font-semibold mb-7">Add Soft Skill</h1>
              <CgClose
